...
echo    - Copia y pega el contenido del archivo 'actualizar-contraseñas.sql'
echo    - Haz clic en 'Continuar'
echo.

echo 2. Este script hará lo siguiente:
echo    - Actualizará las contraseñas con hashes correctos de BCrypt
...
echo 4. Después de ejecutar el SQL, el login debería funcionar.
echo.
