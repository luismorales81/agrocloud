...
const EstablecimientosHuevosScreen: React.FC = () => {
  ...
  const [estEditando, setEstEditando] = useState<AvicolaHuevoEstablecimientoRespuesta | null>(null);
  ...
  const guardarEst = async () => {
    try {
      ...
      if (estEditando) {
        await actualizarEstablecimientoHuevos(estEditando.id, {
        ...
        await crearEstablecimientoHuevos({
          nombre: estNombre.trim(),
          observaciones: estObs.trim() || null,
          activo: estActivo,
          ubicacion: ubicacionCuerpo,
  ...
  const resumenUbicacionTabla = (e: AvicolaHuevoEstablecimientoRespuesta) => {
                    ...
                    <TableRow key={e.id}>
                      ...
                      <TableCell align="right">
                        <IconButton
                          ...
                          to={`/avicola-huevos/establecimientos-mapa?id=${e.id}`}
        ...
        <DialogContent>
          ...
          {estEditando && (
            <Button
              ...
              onClick={() => {
                setDialogoEst(false);
                navigate(`/avicola-huevos/establecimientos-mapa?id=${estEditando.id}`);
              }}
            >
...
export default EstablecimientosHuevosScreen;
