@echo off
echo ========================================
echo   Eliminando humedad de cosecha
echo ========================================

echo 1. Eliminando columna humedad_cosecha...
"C:\Program Files\MySQL\MySQL Server 8.0\bin\mysql.exe" -u root -p123456 -e "USE agrocloud; ALTER TABLE historial_cosechas DROP COLUMN IF EXISTS humedad_cosecha;"
