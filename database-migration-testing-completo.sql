-- ============================================================
-- SCRIPT COMPLETO: Migración TESTING (TODO EN UNO)
...
-- O desde MySQL:
--   USE agrogestion_db;
--   source database-migration-testing-completo.sql;
--
-- ============================================================
...
-- ============================================================
-- PASO 5: INSERTAR DATOS DE TESTING
-- ============================================================
...
SELECT COUNT(*) AS 'Campos' FROM campos;
SELECT COUNT(*) AS 'Lotes' FROM lotes;
SELECT COUNT(*) AS 'Insumos' FROM insumos;
SELECT COUNT(*) AS 'Maquinaria' FROM maquinaria;
SELECT '' AS '';
SELECT '============================================' AS '';
...
-- ============================================================
-- FIN DEL SCRIPT COMPLETO TESTING
-- ============================================================
