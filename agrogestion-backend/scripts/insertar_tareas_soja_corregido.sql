-- Insertar tareas predeterminadas para estados de Soja (con tipos de labor únicos por estado)
...
CROSS JOIN (
    SELECT 'Disponible' as estado, 'LABRANZA' as tipo_labor, 'Arado' as nombre_tarea, 'Preparación profunda del suelo' as descripcion, FALSE as es_obligatoria, 1 as orden
    ...
    UNION ALL SELECT 'Cosechado', 'LABRANZA', 'Arado', 'Preparación para nuevo ciclo', FALSE, 1
) tareas
