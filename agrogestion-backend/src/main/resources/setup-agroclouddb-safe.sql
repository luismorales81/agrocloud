-- =====================================================
-- SCRIPT SEGURO DE CONFIGURACIÓN PARA AGROCLOUDBD
...
-- Crear índices para la tabla campos
SET @sql = (SELECT IF(
    (SELECT COUNT(*) FROM INFORMATION_SCHEMA.STATISTICS 
     WHERE TABLE_SCHEMA = 'agroclouddb' 
     AND TABLE_NAME = 'campos' 
     AND INDEX_NAME = 'idx_campos_user_id') = 0,
    'CREATE INDEX idx_campos_user_id ON campos(user_id);',
    'SELECT ''Índice idx_campos_user_id ya existe'' as message;'
));
...
SET @sql = (SELECT IF(
    (SELECT COUNT(*) FROM INFORMATION_SCHEMA.STATISTICS 
     WHERE TABLE_SCHEMA = 'agroclouddb' 
     AND TABLE_NAME = 'campos' 
     AND INDEX_NAME = 'idx_campos_estado') = 0,
    'CREATE INDEX idx_campos_estado ON campos(estado);',
    'SELECT ''Índice idx_campos_estado ya existe'' as message;'
));
PREPARE stmt FROM @sql;
EXECUTE stmt;
DEALLOCATE PREPARE stmt;
...
SET @sql = (SELECT IF(
    (SELECT COUNT(*) FROM INFORMATION_SCHEMA.STATISTICS 
     WHERE TABLE_SCHEMA = 'agroclouddb' 
     AND TABLE_NAME = 'campos' 
     AND INDEX_NAME = 'idx_campos_activo') = 0,
    'CREATE INDEX idx_campos_activo ON campos(activo);',
    'SELECT ''Índice idx_campos_activo ya existe'' as message;'
));
PREPARE stmt FROM @sql;
EXECUTE stmt;
DEALLOCATE PREPARE stmt;
...
-- Crear índices para la tabla lotes
SET @sql = (SELECT IF(
    (SELECT COUNT(*) FROM INFORMATION_SCHEMA.STATISTICS 
     WHERE TABLE_SCHEMA = 'agroclouddb' 
     AND TABLE_NAME = 'lotes' 
     AND INDEX_NAME = 'idx_lotes_campo_id') = 0,
    'CREATE INDEX idx_lotes_campo_id ON lotes(campo_id);',
    'SELECT ''Índice idx_lotes_campo_id ya existe'' as message;'
));
PREPARE stmt FROM @sql;
EXECUTE stmt;
DEALLOCATE PREPARE stmt;
...
SET @sql = (SELECT IF(
    (SELECT COUNT(*) FROM INFORMATION_SCHEMA.STATISTICS 
     WHERE TABLE_SCHEMA = 'agroclouddb' 
     AND TABLE_NAME = 'lotes' 
     AND INDEX_NAME = 'idx_lotes_estado') = 0,
    'CREATE INDEX idx_lotes_estado ON lotes(estado);',
    'SELECT ''Índice idx_lotes_estado ya existe'' as message;'
));
PREPARE stmt FROM @sql;
EXECUTE stmt;
DEALLOCATE PREPARE stmt;
...
SET @sql = (SELECT IF(
    (SELECT COUNT(*) FROM INFORMATION_SCHEMA.STATISTICS 
     WHERE TABLE_SCHEMA = 'agroclouddb' 
     AND TABLE_NAME = 'lotes' 
     AND INDEX_NAME = 'idx_lotes_cultivo') = 0,
    'CREATE INDEX idx_lotes_cultivo ON lotes(cultivo_actual);',
    'SELECT ''Índice idx_lotes_cultivo ya existe'' as message;'
));
PREPARE stmt FROM @sql;
EXECUTE stmt;
DEALLOCATE PREPARE stmt;

-- Crear índices para la tabla insumos
SET @sql = (SELECT IF(
    (SELECT COUNT(*) FROM INFORMATION_SCHEMA.STATISTICS 
     WHERE TABLE_SCHEMA = 'agroclouddb' 
     AND TABLE_NAME = 'insumos' 
     AND INDEX_NAME = 'idx_insumos_usuario_id') = 0,
    'CREATE INDEX idx_insumos_usuario_id ON insumos(usuario_id);',
    'SELECT ''Índice idx_insumos_usuario_id ya existe'' as message;'
));
PREPARE stmt FROM @sql;
EXECUTE stmt;
DEALLOCATE PREPARE stmt;
...
SET @sql = (SELECT IF(
    (SELECT COUNT(*) FROM INFORMATION_SCHEMA.STATISTICS 
     WHERE TABLE_SCHEMA = 'agroclouddb' 
     AND TABLE_NAME = 'insumos' 
     AND INDEX_NAME = 'idx_insumos_tipo') = 0,
    'CREATE INDEX idx_insumos_tipo ON insumos(tipo);',
    'SELECT ''Índice idx_insumos_tipo ya existe'' as message;'
));
PREPARE stmt FROM @sql;
EXECUTE stmt;
DEALLOCATE PREPARE stmt;
...
SET @sql = (SELECT IF(
    (SELECT COUNT(*) FROM INFORMATION_SCHEMA.STATISTICS 
     WHERE TABLE_SCHEMA = 'agroclouddb' 
     AND TABLE_NAME = 'insumos' 
     AND INDEX_NAME = 'idx_insumos_stock') = 0,
    'CREATE INDEX idx_insumos_stock ON insumos(stock_disponible);',
    'SELECT ''Índice idx_insumos_stock ya existe'' as message;'
));
PREPARE stmt FROM @sql;
EXECUTE stmt;
DEALLOCATE PREPARE stmt;

-- Crear índices para la tabla maquinaria
SET @sql = (SELECT IF(
    (SELECT COUNT(*) FROM INFORMATION_SCHEMA.STATISTICS 
     WHERE TABLE_SCHEMA = 'agroclouddb' 
     AND TABLE_NAME = 'maquinaria' 
     AND INDEX_NAME = 'idx_maquinaria_usuario_id') = 0,
    'CREATE INDEX idx_maquinaria_usuario_id ON maquinaria(usuario_id);',
    'SELECT ''Índice idx_maquinaria_usuario_id ya existe'' as message;'
));
PREPARE stmt FROM @sql;
EXECUTE stmt;
DEALLOCATE PREPARE stmt;
...
SET @sql = (SELECT IF(
    (SELECT COUNT(*) FROM INFORMATION_SCHEMA.STATISTICS 
     WHERE TABLE_SCHEMA = 'agroclouddb' 
     AND TABLE_NAME = 'maquinaria' 
     AND INDEX_NAME = 'idx_maquinaria_estado') = 0,
    'CREATE INDEX idx_maquinaria_estado ON maquinaria(estado);',
    'SELECT ''Índice idx_maquinaria_estado ya existe'' as message;'
));
PREPARE stmt FROM @sql;
EXECUTE stmt;
DEALLOCATE PREPARE stmt;
...
SET @sql = (SELECT IF(
    (SELECT COUNT(*) FROM INFORMATION_SCHEMA.STATISTICS 
     WHERE TABLE_SCHEMA = 'agroclouddb' 
     AND TABLE_NAME = 'maquinaria' 
     AND INDEX_NAME = 'idx_maquinaria_tipo') = 0,
    'CREATE INDEX idx_maquinaria_tipo ON maquinaria(tipo);',
    'SELECT ''Índice idx_maquinaria_tipo ya existe'' as message;'
));
PREPARE stmt FROM @sql;
EXECUTE stmt;
DEALLOCATE PREPARE stmt;

-- Crear índices para la tabla labores
SET @sql = (SELECT IF(
    (SELECT COUNT(*) FROM INFORMATION_SCHEMA.STATISTICS 
     WHERE TABLE_SCHEMA = 'agroclouddb' 
     AND TABLE_NAME = 'labores' 
     AND INDEX_NAME = 'idx_labores_lote_id') = 0,
    'CREATE INDEX idx_labores_lote_id ON labores(lote_id);',
    'SELECT ''Índice idx_labores_lote_id ya existe'' as message;'
));
PREPARE stmt FROM @sql;
EXECUTE stmt;
DEALLOCATE PREPARE stmt;
...
SET @sql = (SELECT IF(
    (SELECT COUNT(*) FROM INFORMATION_SCHEMA.STATISTICS 
     WHERE TABLE_SCHEMA = 'agroclouddb' 
     AND TABLE_NAME = 'labores' 
     AND INDEX_NAME = 'idx_labores_usuario_id') = 0,
    'CREATE INDEX idx_labores_usuario_id ON labores(usuario_id);',
    'SELECT ''Índice idx_labores_usuario_id ya existe'' as message;'
));
PREPARE stmt FROM @sql;
EXECUTE stmt;
DEALLOCATE PREPARE stmt;
...
SET @sql = (SELECT IF(
    (SELECT COUNT(*) FROM INFORMATION_SCHEMA.STATISTICS 
     WHERE TABLE_SCHEMA = 'agroclouddb' 
     AND TABLE_NAME = 'labores' 
     AND INDEX_NAME = 'idx_labores_fecha_inicio') = 0,
    'CREATE INDEX idx_labores_fecha_inicio ON labores(fecha_inicio);',
    'SELECT ''Índice idx_labores_fecha_inicio ya existe'' as message;'
));
PREPARE stmt FROM @sql;
EXECUTE stmt;
DEALLOCATE PREPARE stmt;
...
SET @sql = (SELECT IF(
    (SELECT COUNT(*) FROM INFORMATION_SCHEMA.STATISTICS 
     WHERE TABLE_SCHEMA = 'agroclouddb' 
     AND TABLE_NAME = 'labores' 
     AND INDEX_NAME = 'idx_labores_estado') = 0,
    'CREATE INDEX idx_labores_estado ON labores(estado);',
    'SELECT ''Índice idx_labores_estado ya existe'' as message;'
));
PREPARE stmt FROM @sql;
EXECUTE stmt;
DEALLOCATE PREPARE stmt;

-- Crear índices para la tabla mantenimiento_maquinaria
SET @sql = (SELECT IF(
    (SELECT COUNT(*) FROM INFORMATION_SCHEMA.STATISTICS 
     WHERE TABLE_SCHEMA = 'agroclouddb' 
     AND TABLE_NAME = 'mantenimiento_maquinaria' 
     AND INDEX_NAME = 'idx_mantenimiento_maquinaria_id') = 0,
    'CREATE INDEX idx_mantenimiento_maquinaria_id ON mantenimiento_maquinaria(maquinaria_id);',
    'SELECT ''Índice idx_mantenimiento_maquinaria_id ya existe'' as message;'
));
PREPARE stmt FROM @sql;
EXECUTE stmt;
DEALLOCATE PREPARE stmt;
...
SET @sql = (SELECT IF(
    (SELECT COUNT(*) FROM INFORMATION_SCHEMA.STATISTICS 
     WHERE TABLE_SCHEMA = 'agroclouddb' 
     AND TABLE_NAME = 'mantenimiento_maquinaria' 
     AND INDEX_NAME = 'idx_mantenimiento_usuario_id') = 0,
    'CREATE INDEX idx_mantenimiento_usuario_id ON mantenimiento_maquinaria(usuario_id);',
    'SELECT ''Índice idx_mantenimiento_usuario_id ya existe'' as message;'
));
PREPARE stmt FROM @sql;
EXECUTE stmt;
DEALLOCATE PREPARE stmt;
...
SET @sql = (SELECT IF(
    (SELECT COUNT(*) FROM INFORMATION_SCHEMA.STATISTICS 
     WHERE TABLE_SCHEMA = 'agroclouddb' 
     AND TABLE_NAME = 'mantenimiento_maquinaria' 
     AND INDEX_NAME = 'idx_mantenimiento_fecha') = 0,
    'CREATE INDEX idx_mantenimiento_fecha ON mantenimiento_maquinaria(fecha_mantenimiento);',
    'SELECT ''Índice idx_mantenimiento_fecha ya existe'' as message;'
));
PREPARE stmt FROM @sql;
EXECUTE stmt;
DEALLOCATE PREPARE stmt;
