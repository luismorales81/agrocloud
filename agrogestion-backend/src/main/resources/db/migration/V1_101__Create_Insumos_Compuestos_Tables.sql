...
-- Descripción: Almacena las recetas/formulas de insumos compuestos
--              Compartido entre módulos (Cultivos y Porcinos)
--              Ejemplos: Raciones de alimento, mezclas de fertilizantes, preparados de agroquímicos
-- ============================================================================
...
-- Descripción: Almacena los ingredientes (componentes) de cada insumo compuesto
-- ============================================================================
CREATE TABLE IF NOT EXISTS componentes_insumo_compuesto (
    ...
    cultivo_id BIGINT NULL COMMENT 'Referencia a cultivos (maíz propio, soja propia)',
...
-- Descripción: Asocia recetas (insumos compuestos) a etapas de alimentación
-- ============================================================================
CREATE TABLE IF NOT EXISTS porcinos_recetas_alimentacion_etapa (
    ...
    -- Nota: La validación de una sola receta por defecto por etapa se hace a nivel de aplicación
