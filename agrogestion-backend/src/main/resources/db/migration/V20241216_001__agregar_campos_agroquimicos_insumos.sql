-- Migración para agregar campos específicos de agroquímicos a la tabla insumos
-- Integra propiedades específicas de agroquímicos con el sistema de insumos existente
