...
/**
 * Consumo de alimento (insumo CORE); el movimiento de stock se registra vía servicio con origen AVICOLA_PONEDORAS.
 */
@Entity
@Table(name = "avicola_ponedoras_consumo")
@EntityListeners(AuditingEntityListener.class)
public class AvicolaPonedorasConsumo {
    ...
    private AvicolaPonedorasConsumoTipo tipo = AvicolaPonedorasConsumoTipo.MANUAL;
