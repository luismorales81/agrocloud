...
/**
 * Entidad que representa un permiso en el sistema (Core).
 */
@Entity
@Table(name = "permisos")
...
public class Permission {
    ...
    public String toString() {
        return "Permission{id=" + id + ", nombre='" + nombre + '\'' + ", descripcion='" + descripcion + '\'' + ", modulo='" + modulo + '\'' + ", accion='" + accion + '\'' + ", activo=" + activo + ", fechaCreacion=" + fechaCreacion + '}';
    }
}
