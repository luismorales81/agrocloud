...
import com.agrocloud.core.infrastructure.CompanyRepository;
import com.agrocloud.core.infrastructure.PermissionRepository;
import com.agrocloud.core.infrastructure.RolePermissionRepository;
 ...
 * @version 1.0.0
 */
@Service("multiTenantServiceCore")
@Transactional
public class MultiTenantService {
    ...
    @Autowired
    @Qualifier("companyRepositoryCore")
    ...
    @Autowired
    @Qualifier("permissionRepositoryCore")
    ...
    @Autowired
    @Qualifier("rolePermissionRepositoryCore")
