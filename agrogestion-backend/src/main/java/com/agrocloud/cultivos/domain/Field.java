...
public class Field {
    ...
    public List<Plot> getLotes() { return lotes; }
    public void setLotes(List<Plot> lotes) { this.lotes = lotes; }
    ...
    public void addLote(Plot lote) { lotes.add(lote); lote.setCampo(this); }
    public void removeLote(Plot lote) { lotes.remove(lote); lote.setCampo(null); }
    @Override
    public String toString() { return "Field{id=" + id + ", nombre='" + nombre + "', areaHectareas=" + areaHectareas + ", estado='" + estado + "', activo=" + activo + "}"; }
}
