...
/**
 * Serializer personalizado para enmascarar emails en respuestas JSON
 */
@Component
public class EmailMaskingSerializer extends JsonSerializer<String> implements ApplicationContextAware {

    private static ApplicationContext applicationContext;

    @Override
    public void setApplicationContext(@NonNull ApplicationContext applicationContext) throws BeansException {
        EmailMaskingSerializer.applicationContext = applicationContext;
    }
    ...
    public void serialize(String email, JsonGenerator gen, SerializerProvider serializers) throws IOException {
        if (email == null) {
            ...
            try {
                ...
                String emailEnmascarado = service.enmascararEmail(email);
                gen.writeString(emailEnmascarado);
            } catch (Exception e) {
