...
public class MaquinariaController {
    ...
    // Obtener maquinarias por tipo
    @GetMapping("/tipo/{tipo}")
    public ResponseEntity<List<Maquinaria>> getMaquinariasByTipo(@PathVariable Maquinaria.TipoMaquinaria tipo, @AuthenticationPrincipal UserDetails userDetails) {
        User user = userService.findByUsername(userDetails.getUsername());
