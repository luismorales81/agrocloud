...
public class TipoServicioPorcino {
    ...
    public enum TipoServicio {
        MONTA_NATURAL_DIRECTA, IA_POSCERVICAL, IA_TRADICIONAL, SERVICIO_REPETIDO
    }

    public TipoServicioPorcino() {}

    public TipoServicioPorcino(String nombre, TipoServicio tipo, Empresa empresa) {
        this.nombre = nombre;
        this.tipo = tipo;
