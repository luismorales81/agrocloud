-- ============================================================
-- SCRIPT COMPLETO: Migración TESTING (ESTRUCTURA LIMPIA)
...
-- - Roles del sistema
-- - Cultivos base
-- - SIN datos de prueba (para que agregues los tuyos)
--
...
-- ============================================================
-- PASO 1: Usar base de datos
-- ============================================================

USE `agrogestion_db`;

-- ============================================================
-- PASO 2: ELIMINAR TODAS LAS TABLAS EXISTENTES
-- ============================================================
-- Orden: De tablas dependientes a tablas principales
-- Para respetar las restricciones de integridad referencial

-- Eliminar tablas de tu base actual (en orden correcto)
...
-- Eliminar tablas que tienes actualmente
...
-- Tabla: usuario_empresas (Sistema NUEVO)
...
-- Tabla: usuarios_empresas_roles (Sistema ANTIGUO)
...
-- ============================================================
-- PASO 4: INSERTAR DATOS INICIALES (Roles y Cultivos)
-- ============================================================
...
SELECT '============================================' AS '';
SELECT '1. Crear tu empresa' AS '';
SELECT '2. Crear tus usuarios' AS '';
SELECT '3. Asignar roles a usuarios' AS '';
SELECT '4. Crear campos y lotes' AS '';
SELECT '5. Agregar insumos y maquinaria' AS '';
SELECT '============================================' AS '';

-- ============================================================
-- FIN DEL SCRIPT LIMPIO
-- ============================================================
